				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-xl-2 col-lg-2 col-md-2">
							<div class="logo">
								<a href="afterLogProj.jsp"><img src="assets/img/icon.png"
									alt=""></a>
							</div>
						</div>
								...
								<nav>
									<ul id="navigation">
										...
										<li><a href="services.html" title="설정"><img
											...
											<ul class="submenu">
												<li><a href="setting.jsp">계정 설정</a></li>
							...
							<%
							    ...
							    String name = pro.ProName(userID, i);
							       ...
							       <a href="toDoListLastVer.jsp?proj_name=<%=name%>">
							       	   <button type="button" value=<%=name%> class="btn-danger" style="width: 26.5%; height: 140px; border-radius: 10px; margin: 3%"><%=name%></button>		
								   </a>
							<%}%>
						</article>
					</div>
