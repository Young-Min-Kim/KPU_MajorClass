...
<jsp:setProperty name="user" property="introduce" />
...
<body>
	<%
		...
		if (user.getId() == null || user.getPasswd() == null || user.getName() == null || user.getEmail() == null){
				PrintWriter script = response.getWriter();
				script.println("<script>");
				...
				//가입성공
					...
					PrintWriter script = response.getWriter();
					script.println("<script>");
					script.println("alert('가입 완료 되었습니다.')");
